...
/**
 * This class performs the removing of white columns of an image by means of #{@link Filter} class methods.
 * 
 * @author ChiarellaG
 *
 */
public class HorizontalJoinPreprocess extends AbstractPreprocess {
	 ...
	 */
	public HorizontalJoinPreprocess(PreprocessingType p) {
		super(p);
	}
	 ...
	 */
	public HorizontalJoinPreprocess(HorizontalJoinPreprocess p) {
		super(p);
	}
