...
/**
 * This class returns the input image as is.
 * 
 * @author ChiarellaG
 *
 */
public class NonePreprocess extends AbstractPreprocess {
	 ...
	 */
	public NonePreprocess(PreprocessingType p) {
		super(p);
	}
	 ...
	 */
	public NonePreprocess(NonePreprocess p) {
		super(p);
	}
