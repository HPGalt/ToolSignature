...
import it.corvallis.imageprocessing.measurements.TrisurfaceProcessor;

import java.util.Arrays;

/**
 * The class to compute the TriSurface feature. It extends the class {@link AbstractFeature}.
 * The algorithm is provided by means of the {@link TrisurfaceProcessor} class.
 * 
 * @author ChiarellaG
 *
 */
public class TriSurfaceFeature extends AbstractFeature {
	 ...
	 */
	public TriSurfaceFeature(FeatureType feat) {
		super(feat);
	}
	 ...
	 */
	public TriSurfaceFeature(TriSurfaceFeature f) {
		super(f);
	}

	@Override
	protected Object computeFeature(ImagePlus img, double... parameters) {
		TrisurfaceProcessor tmpProcessor = new TrisurfaceProcessor(img);
		return tmpProcessor.getTrisurface();
	}
