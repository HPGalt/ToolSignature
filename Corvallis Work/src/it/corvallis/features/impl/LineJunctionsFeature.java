...
/**
 * The class to compute the Line Junction feature. It extends the class {@link AbstractFeature}.
 * The algorithm is provided by means of the {@link Filter#crossFinder} method.
 * 
 * @author ChiarellaG
 *
 */
public class LineJunctionsFeature extends AbstractFeature {
	 ...
	 */
	public LineJunctionsFeature(FeatureType feat) {
		super(feat);
	}
	 ...
	 */
	public LineJunctionsFeature(LineJunctionsFeature f) {
		super(f);
	}
	
	@Override
	protected Object computeFeature(ImagePlus img, double... parameters) {
		return new double[]{Filter.crossFinder(img, (int) parameters[0]).getRight()};
	}
