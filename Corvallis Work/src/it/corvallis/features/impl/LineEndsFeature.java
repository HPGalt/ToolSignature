...
/**
 * The class to compute the Line Ends feature. It extends the class {@link AbstractFeature}.
 * The algorithm is provided by means of the {@link Filter#lineEndsCounter(ImagePlus)} class.
 * 
 * @author ChiarellaG
 *
 */
public class LineEndsFeature extends AbstractFeature {
	 ...
	 */
	public LineEndsFeature(FeatureType feat) {
		super(feat);
	}
	 ...
	 */
	public LineEndsFeature(LineEndsFeature f) {
		super(f);
	}
	
	@Override
	protected Object computeFeature(ImagePlus img, double... parameters) {
		return new double[]{Filter.lineEndsCounter(img)};
	}
