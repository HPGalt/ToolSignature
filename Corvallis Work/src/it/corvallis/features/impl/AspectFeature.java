...
/**
 * The class to compute the Aspect of an image. It extends the class {@link AbstractFeature}.
 * 
 * @author ChiarellaG
 *
 */
public class AspectFeature extends AbstractFeature {
	 ...
	 */
	public AspectFeature(FeatureType feat) {
		super(feat);
	}
	 ...
	 */
	public AspectFeature(AspectFeature f) {
		super(f);
	}
