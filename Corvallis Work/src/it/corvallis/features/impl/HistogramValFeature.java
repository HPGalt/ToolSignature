...
/**
 * The class to compute the maximum value of the histogram of the input image. It extends the class {@link AbstractFeature}.
 * The algorithm is provided by means of the {@link GlobalFeaturesProcessor} class.
 * 
 * @author ChiarellaG
 *
 */
public class HistogramValFeature extends AbstractFeature {
	 ...
	 */
	public HistogramValFeature(FeatureType feat) {
		super(feat);
	}
	 ...
	 */
	public HistogramValFeature(HistogramValFeature f) {
		super(f);
	}
	...
	protected Object computeFeature(ImagePlus img, double... parameters) {
		...
		return globalFeaturesProcessor.getHistogramValues();
	}
