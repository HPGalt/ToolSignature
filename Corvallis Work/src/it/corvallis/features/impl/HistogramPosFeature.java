...
import it.corvallis.imageprocessing.measurements.GlobalFeaturesProcessor;

import java.util.Arrays;

/**
 * The class to compute the position of the maximum value of the histogram of the input image. It extends the class {@link AbstractFeature}.
 * The algorithm is provided by means of the {@link GlobalFeaturesProcessor} class.
 * 
 * @author ChiarellaG
 *
 */
public class HistogramPosFeature extends AbstractFeature {
	 ...
	 */
	public HistogramPosFeature(FeatureType feat) {
		super(feat);
	}
	 ...
	 */
	public HistogramPosFeature(HistogramPosFeature f) {
		super(f);
	}
	
	@Override
	protected Object computeFeature(ImagePlus img, double... parameters) {
		GlobalFeaturesProcessor globalFeaturesProcessor = new GlobalFeaturesProcessor(img);
		globalFeaturesProcessor.computeHistograms();
		return globalFeaturesProcessor.getHistogramPositions();
	}
