...
/**
 * The class to compute the Centroid. It extends the class {@link AbstractFeature}.
 * The algorithm is provided by means of {@link CentroidProcessor} class.
 * 
 * @author ChiarellaG
 *
 */
public class CentroidFeature extends AbstractFeature {
	 ...
	 */
	public CentroidFeature(FeatureType feat) {
		super(feat);
	}
	 ...
	 */
	public CentroidFeature(CentroidFeature f) {
		super(f);
	}
	
	@Override
	protected Object computeFeature(ImagePlus img, double... parameters) {
		return new double[]{new CentroidProcessor(img).getCentroid()};
	}
