 ...
 *
 */
public class NumberOfTransitionsFeature extends AbstractFeature {
	 ...
	 */
	public NumberOfTransitionsFeature(FeatureType feat) {
		super(feat);
	}
	 ...
	 */
	public NumberOfTransitionsFeature(NumberOfTransitionsFeature f) {
		super(f);
	}
	...
	protected Object computeFeature(ImagePlus img, double... parameters) {
		...
		return globalFeaturesProcessor.getNumberOfTransitions();
	}
