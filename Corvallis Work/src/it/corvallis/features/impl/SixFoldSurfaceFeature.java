...
import it.corvallis.imageprocessing.measurements.SixfoldSurfaceProcessor;

import java.util.Arrays;

/**
 * The class to compute the SixFoldSurface feature. It extends the class {@link AbstractFeature}.
 * The algorithm is provided by means of the {@link SixfoldSurfaceProcessor} class.
 * 
 * @author ChiarellaG
 *
 */
public class SixFoldSurfaceFeature extends AbstractFeature {
	 ...
	 */
	public SixFoldSurfaceFeature(FeatureType feat) {
		super(feat);
	}
	 ...
	 */
	public SixFoldSurfaceFeature(SixFoldSurfaceFeature f) {
		super(f);
	}

	@Override
	protected Object computeFeature(ImagePlus img, double... parameters) {
		return new SixfoldSurfaceProcessor(img).getSixfoldSurface();
	}
