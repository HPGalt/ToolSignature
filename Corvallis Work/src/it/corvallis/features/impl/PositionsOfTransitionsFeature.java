...
/**
 * The class to compute the NumberOfTransitions feature. It extends the class {@link AbstractFeature}.
 * The algorithm is provided by means of the {@link GlobalFeaturesProcessor} class.
 * 
 * @author ChiarellaG
 *
 */
public class PositionsOfTransitionsFeature extends AbstractFeature {
	 ...
	 */
	public PositionsOfTransitionsFeature(FeatureType feat) {
		super(feat);
	}
	 ...
	 */
	public PositionsOfTransitionsFeature(PositionsOfTransitionsFeature f) {
		super(f);
	}
	...
	protected Object computeFeature(ImagePlus img, double... parameters) {
		...
		globalFeaturesProcessor.transitions();
		return globalFeaturesProcessor.getPositionsOfTransitions();
	}
